...
public:
    ...
    void handleDeleteLastWaypoint(const std::shared_ptr<std_srvs::srv::Trigger::Request> req, std::shared_ptr<std_srvs::srv::Trigger::Response> res);
    void publishLineMarker();
    void publishTotalWpsDist();
    void publishLastWpsDist();
    void publishCurrentWaypoints();
    void recalculateWaypointDistances();
...
private:
    ...
    rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr current_waypoints_pub_;
    rclcpp::TimerBase::SharedPtr line_timer_;
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr save_service_;
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr load_service_;
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr delete_last_service_;
