...
namespace gazebo
{
   ...
   private:
      void InitializeRays(std::vector<std::pair<std::size_t, const AviaRotateInfo *>> &points_pair,
      ...
      std::vector<std::pair<std::size_t, const AviaRotateInfo *>> scan_points_;
      ...
      uint32_t point_time_increment_ns_ = 0;
