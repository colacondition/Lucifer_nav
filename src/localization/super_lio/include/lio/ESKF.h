...
public:
  ...
  bool ApplyVerticalConstraint(BASIC::scalar z_ref,
                               BASIC::scalar pos_std,
                               BASIC::scalar vel_std,
                               BASIC::scalar max_pos_correction);
...
private:
  ...
  bool Update();
  void ResetForwardPrediction(const IMUData& imu);
