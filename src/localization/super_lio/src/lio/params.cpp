...
namespace LI2Sup{
  ...
  bool g_z_constraint_enable = false;
  bool g_z_constraint_use_initial_height = true;
  double g_z_constraint_reference = 0.0;
  double g_z_constraint_pos_std = 0.03;
  double g_z_constraint_vel_std = 0.10;
  double g_z_constraint_max_correction = 0.20;
