# ROS 2 pointcloud to laserscan converter

This package keeps the `sensor_msgs/msg/PointCloud2` to `sensor_msgs/msg/LaserScan`
converter used by the HL navigation bringup.
