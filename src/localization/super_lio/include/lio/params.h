...
namespace LI2Sup{
  ...
  extern bool g_z_constraint_enable;
  extern bool g_z_constraint_use_initial_height;
  extern double g_z_constraint_reference;
  extern double g_z_constraint_pos_std;
  extern double g_z_constraint_vel_std;
  extern double g_z_constraint_max_correction;
